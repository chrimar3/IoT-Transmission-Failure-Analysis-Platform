...
export type MaintenanceCategory = 'preventive' | 'corrective' | 'predictive' | 'emergency'
...
export type HistoricalOutcome = 'failure_prevented' | 'failure_occurred' | 'false_positive' | 'unknown'
...
export type AcknowledgmentOutcome = 'resolved' | 'monitoring' | 'escalated' | 'false_positive'
