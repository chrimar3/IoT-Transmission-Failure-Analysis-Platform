...
describe('Bangkok Dataset Validation Scenarios', () => {
  ...
  describe('Realistic Bangkok Office Building Scenarios', () => {
    it('should accurately detect morning energy spike during hot season', async () => {
      ...
      const morningHotSeasonData: SensorReading[] = [
        // HVAC energy consumption - main system
        {
          ...
          timestamp: '2025-04-15T02:30:00.000Z',
          value: 850,
          unit: 'kWh',
          quality: 'good',
        },
        {
          sensor_id: 'BKK_SILOM_HVAC_MAIN',
          timestamp: '2025-04-15T02:35:00.000Z',
          value: 920,
          unit: 'kWh',
          quality: 'good',
        },
        {
          sensor_id: 'BKK_SILOM_HVAC_MAIN',
          timestamp: '2025-04-15T02:40:00.000Z',
          value: 1150,
          unit: 'kWh',
          quality: 'good',
        },
        {
          sensor_id: 'BKK_SILOM_HVAC_MAIN',
          timestamp: '2025-04-15T02:45:00.000Z',
          value: 1380,
          unit: 'kWh',
          quality: 'good',
        },
        {
          sensor_id: 'BKK_SILOM_HVAC_MAIN',
          timestamp: '2025-04-15T02:50:00.000Z',
          value: 1620,
          unit: 'kWh',
          quality: 'good',
        }, // Spike begins
      ...
      const bangkokAlertConfig: AlertConfiguration = {
        ...
        description:
          'Monitor for excessive energy consumption during business hours in Bangkok office',
        ...
        rules: [
          {
            ...
            description:
              'Detect when HVAC energy consumption exceeds normal levels during morning hours',
            enabled: true,
            priority: 'high',
            conditions: [
              {
      ...
      const bangkokContext: EvaluationContext = {
        ...
        historical_data: [
          ...
          {
            sensor_id: 'BKK_SILOM_HVAC_MAIN',
            timestamp: '2025-04-14T02:50:00.000Z',
            value: 1250,
            unit: 'kWh',
            quality: 'good',
          },
          {
            sensor_id: 'BKK_SILOM_HVAC_MAIN',
            timestamp: '2025-04-13T02:50:00.000Z',
            value: 1180,
            unit: 'kWh',
            quality: 'good',
          },
        ...
        occupancy_data: {
          ...
          events_scheduled: [
            'Board meeting - Floor 20',
            'Training session - Floor 15',
          ],
        },
      };
      ...
      expect(alert.title).toContain(
        'Bangkok Silom Office - Critical Energy Alert'
      );

      // Validate metric evaluations
      expect(alert.metric_values).toHaveLength(2); // Energy and occupancy conditions

      const energyMetric = alert.metric_values.find(
        (m) => m.metric.type === 'energy_consumption'
      );
      ...
      const occupancyMetric = alert.metric_values.find(
        (m) => m.metric.type === 'occupancy'
      );
      ...
      expect(alert.context.weather_conditions?.weather_condition).toBe(
        'clear_sky'
      );
    ...
    it('should handle hot season energy spikes during peak hours', async () => {
      ...
      const hotSeasonPeakData: SensorReading[] = [
        // HVAC energy consumption reaching critical levels
        {
          ...
          timestamp: '2025-03-28T07:00:00.000Z',
          value: 1800,
          unit: 'kWh',
          quality: 'good',
        },
        {
          sensor_id: 'BKK_CBD_HVAC_MAIN',
          timestamp: '2025-03-28T07:15:00.000Z',
          value: 2100,
          unit: 'kWh',
          quality: 'good',
        },
        {
          sensor_id: 'BKK_CBD_HVAC_MAIN',
          timestamp: '2025-03-28T07:30:00.000Z',
          value: 2350,
          unit: 'kWh',
          quality: 'good',
        }, // Critical spike
        ...
        {
          sensor_id: 'BKK_CBD_TEMP_INDOOR_AVG',
          timestamp: '2025-03-28T07:30:00.000Z',
          value: 27,
          unit: '°C',
          quality: 'good',
        ...
        {
          sensor_id: 'BKK_CBD_SOLAR_IRRADIANCE',
          timestamp: '2025-03-28T07:30:00.000Z',
          value: 1200,
          unit: 'W/m²',
          quality: 'good',
      ...
      const hotSeasonAlertConfig: AlertConfiguration = {
        ...
        description:
          'Critical alert for extreme energy consumption during hot season peak hours',
        ...
        rules: [
          {
            ...
            description:
              'Detect when HVAC energy reaches crisis levels during extreme heat',
            enabled: true,
            priority: 'critical',
            conditions: [
              {
      ...
      const hotSeasonAlerts = await alertEngine.evaluateAlerts(
        [hotSeasonAlertConfig],
        hotSeasonContext
      );
      ...
      const tempMetric = alert.metric_values.find(
        (m) => m.metric.type === 'temperature'
      );
      const occupancyMetric = alert.metric_values.find(
        (m) => m.metric.type === 'occupancy'
      );
      ...
      expect(alert.context.weather_conditions?.forecast_change).toBe(
        'worsening'
      );
    ...
    it('should handle monsoon season HVAC patterns correctly', async () => {
      ...
      const monsoonSeasonData: SensorReading[] = [
        ...
        {
          sensor_id: 'BKK_ASOK_HVAC_MAIN',
          timestamp: '2025-08-20T05:45:00.000Z',
          value: 1450,
          unit: 'kWh',
          quality: 'good',
        },
      ...
      const monsoonAlertConfig: AlertConfiguration = {
        ...
        description:
          'Special monitoring for HVAC efficiency during monsoon season',
        user_id: 'bangkok_facilities_manager',
        organization_id: 'company_thailand',
        status: 'active',
        ...
        rules: [
          {
            ...
            description:
              'Monitor HVAC performance during high humidity conditions',
            enabled: true,
            priority: 'medium',
            conditions: [
              {
      ...
      const humidityMetric = alert.metric_values.find(
        (m) => m.metric.type === 'humidity'
      );
    ...
    it('should accurately detect air quality degradation during Bangkok pollution events', async () => {
      ...
      const pollutionEventData: SensorReading[] = [
        ...
        {
          sensor_id: 'BKK_CBD_HVAC_FILTER_PRESSURE',
          timestamp: '2025-01-15T02:00:00.000Z',
          value: 85,
          unit: 'Pa',
          quality: 'good',
      ...
      const airQualityAlertConfig: AlertConfiguration = {
        ...
        description:
          'Monitor for dangerous air quality levels and building air filtration response',
        ...
        notification_settings: {
          channels: [
            ...
            },
            {
              ...
              configuration: {
                webhook_url:
                  'https://building-automation.company.com/air-quality-alert',
                webhook_method: 'POST',
                webhook_headers: {
      ...
      const airQualityAlerts = await alertEngine.evaluateAlerts(
      ...
      const pm25Metric = alert.metric_values.find(
        (m) => m.metric.sensor_id === 'BKK_CBD_AQ_PM25'
      );
      ...
      expect(alert.context.weather_conditions?.forecast_change).toBe('stable');
      ...
      const webhookNotification = notifications.find(
        (n) => n.channel === 'webhook'
      );
    ...
    it('should handle power grid instability during Bangkok peak demand', async () => {
      ...
      const gridInstabilityData: SensorReading[] = [
        // Building power consumption
        {
          ...
          timestamp: '2025-04-20T07:00:00.000Z',
          value: 2800,
          unit: 'kW',
          quality: 'good',
        },
        {
          sensor_id: 'BKK_TOWER_POWER_MAIN',
          timestamp: '2025-04-20T07:15:00.000Z',
          value: 3200,
          unit: 'kW',
          quality: 'good',
        },
        {
          sensor_id: 'BKK_TOWER_POWER_MAIN',
          timestamp: '2025-04-20T07:30:00.000Z',
          value: 3650,
          unit: 'kW',
          quality: 'good',
        }, // Peak demand
        ...
        {
          sensor_id: 'BKK_TOWER_POWER_FACTOR',
          timestamp: '2025-04-20T07:30:00.000Z',
          value: 0.78,
          unit: 'pf',
          quality: 'good',
        ...
        {
          sensor_id: 'BKK_TOWER_UPS_BATTERY',
          timestamp: '2025-04-20T07:30:00.000Z',
          value: 92,
          unit: '%',
          quality: 'good',
        ...
        // Generator status
        {
          sensor_id: 'BKK_TOWER_GENERATOR_STATUS',
          timestamp: '2025-04-20T07:30:00.000Z',
          value: 1,
          unit: 'status',
          quality: 'good',
      ...
      const gridStabilityAlertConfig: AlertConfiguration = {
        ...
        description:
          'Monitor building power systems during grid instability periods',
        ...
        rules: [
          {
            ...
            description:
              'Alert when building power demand approaches grid capacity limits',
            enabled: true,
            priority: 'high',
            conditions: [
              {
          ...
          channels: [
            {
              ...
              configuration: {
                email_addresses: [
                  'electrical.team@company.com',
                  'ops.bangkok@company.com',
                ],
              },
      ...
      const gridContext: EvaluationContext = {
        ...
        weather_data: {
          ...
          humidity: 70,
          wind_speed: 5,
          solar_irradiance: 1100,
          weather_condition: 'clear_sky',
          forecast_change: 'stable',
        },
      };

      const gridAlerts = await alertEngine.evaluateAlerts(
        [gridStabilityAlertConfig],
        gridContext
      );
      ...
      const powerMetric = alert.metric_values.find(
        (m) => m.metric.type === 'power_demand'
      );
      const voltageMetric = alert.metric_values.find(
        (m) => m.metric.sensor_id === 'BKK_TOWER_GRID_VOLTAGE'
      );
  ...
  describe('Edge Cases and Error Scenarios', () => {
    it('should detect power grid instability during Bangkok peak demand periods', async () => {
      ...
      const gridStressData: SensorReading[] = [
        // Building power consumption climbing
        {
          ...
          timestamp: '2025-05-10T06:00:00.000Z',
          value: 3800,
          unit: 'kW',
          quality: 'good',
        },
        {
          sensor_id: 'BKK_POWER_MAIN_FEED',
          timestamp: '2025-05-10T06:15:00.000Z',
          value: 4200,
          unit: 'kW',
          quality: 'good',
        },
        {
          sensor_id: 'BKK_POWER_MAIN_FEED',
          timestamp: '2025-05-10T06:30:00.000Z',
          value: 4650,
          unit: 'kW',
          quality: 'good',
        }, // Near capacity
        ...
        // Power factor degradation
        {
          sensor_id: 'BKK_POWER_FACTOR_METER',
          timestamp: '2025-05-10T06:30:00.000Z',
          value: 0.75,
          unit: 'pf',
          quality: 'good',
        ...
        {
          sensor_id: 'BKK_UPS_SWITCH_COUNT',
          timestamp: '2025-05-10T06:30:00.000Z',
          value: 5,
          unit: 'count',
          quality: 'good',
      ...
      const gridStabilityConfig: AlertConfiguration = {
        ...
        description:
          'Monitor building power systems during grid instability and peak demand',
        ...
        rules: [
          {
            ...
            description:
              'Detect when building approaches power capacity during grid stress',
            enabled: true,
            priority: 'critical',
            conditions: [
              {
      ...
      const gridStressContext: EvaluationContext = {
        ...
        historical_data: [
          ...
          {
            sensor_id: 'BKK_POWER_MAIN_FEED',
            timestamp: '2025-05-09T06:30:00.000Z',
            value: 3200,
            unit: 'kW',
            quality: 'good',
          },
      ...
      const voltageMetric = alert.metric_values.find(
        (m) => m.metric.sensor_id === 'BKK_GRID_VOLTAGE_MONITOR'
      );
    ...
    it('should handle sensor communication failures during Bangkok network outages', async () => {
      const networkOutageData: SensorReading[] = [
        // Some sensors working
        {
          ...
          timestamp: '2025-03-10T03:00:00.000Z',
          value: 1200,
          unit: 'kWh',
          quality: 'good',
        },
        ...
        {
          sensor_id: 'BKK_PRIMARY_SENSOR_001',
          timestamp: '2025-03-10T03:00:00.000Z',
          value: 0,
          unit: 'kWh',
          quality: 'error',
        ...
        {
          sensor_id: 'BKK_PRIMARY_SENSOR_002',
          timestamp: '2025-03-10T02:45:00.000Z',
          value: 850,
          unit: 'kWh',
          quality: 'warning',
        },
        ...
        {
          sensor_id: 'BKK_NETWORK_SENSOR_001',
          timestamp: '2025-03-10T01:00:00.000Z',
          value: 900,
          unit: 'kWh',
          quality: 'good',
        },
      ...
      const resilientAlertConfig: AlertConfiguration = {
        ...
        description:
          'Continue monitoring during network disruptions using available sensors',
        ...
        metadata: {
          ...
          affected_systems: ['building_automation'],
      ...
      const resilientAlerts = await alertEngine.evaluateAlerts(
        [resilientAlertConfig],
        outageContext
      );
      ...
      const backupMetric = alert.metric_values.find(
        (m) => m.metric.sensor_id === 'BKK_BACKUP_SENSOR_001'
      );
    ...
    it('should validate data quality and reject invalid Bangkok sensor readings', async () => {
      const invalidSensorData: SensorReading[] = [
        ...
        {
          sensor_id: 'BKK_TEMP_INVALID',
          timestamp: '2025-05-15T04:00:00.000Z',
          value: -10,
          unit: '°C',
          quality: 'error',
        },
        ...
        {
          sensor_id: 'BKK_HUMIDITY_INVALID',
          timestamp: '2025-05-15T04:00:00.000Z',
          value: 150,
          unit: '%RH',
          quality: 'error',
      ...
      const validationAlerts = await alertEngine.evaluateAlerts(
    ...
    it('should handle Bangkok network outages with fallback monitoring', async () => {
      ...
      const networkOutageData: SensorReading[] = [
        ...
        {
          sensor_id: 'BKK_PRIMARY_ENERGY_001',
          timestamp: '2025-07-12T02:00:00.000Z',
          value: 0,
          unit: 'kWh',
          quality: 'error',
        },
        {
          sensor_id: 'BKK_PRIMARY_TEMP_001',
          timestamp: '2025-07-12T02:00:00.000Z',
          value: 0,
          unit: '°C',
          quality: 'error',
        ...
        {
          sensor_id: 'BKK_BACKUP_ENERGY_CELLULAR',
          timestamp: '2025-07-12T04:45:00.000Z',
          value: 1520,
          unit: 'kWh',
          quality: 'good',
        },
        {
          sensor_id: 'BKK_BACKUP_ENERGY_CELLULAR',
          timestamp: '2025-07-12T05:00:00.000Z',
          value: 1650,
          unit: 'kWh',
          quality: 'good',
        }, // Still shows spike
        ...
        {
          sensor_id: 'BKK_NETWORK_STATUS_BACKUP',
          timestamp: '2025-07-12T05:00:00.000Z',
          value: 1,
          unit: 'status',
          quality: 'good',
        ...
        {
          sensor_id: 'BKK_BACKUP_OCCUPANCY_BATTERY',
          timestamp: '2025-07-12T05:00:00.000Z',
          value: 85,
          unit: 'count',
          quality: 'good',
      ...
      const networkResilienceConfig: AlertConfiguration = {
        ...
        description:
          'Continue critical monitoring during network outages using backup systems',
        ...
        rules: [
          {
            ...
            description:
              'Monitor energy consumption using backup sensors during network outages',
            enabled: true,
            priority: 'high',
            conditions: [
              {
        ...
        metadata: {
          ...
          affected_systems: ['building_automation', 'fire_safety'],
      ...
      const outageContext: EvaluationContext = {
        ...
        historical_data: [
          ...
          {
            sensor_id: 'BKK_BACKUP_ENERGY_CELLULAR',
            timestamp: '2025-07-11T05:00:00.000Z',
            value: 1200,
            unit: 'kWh',
            quality: 'good',
          },
      ...
      const outageAlerts = await alertEngine.evaluateAlerts(
      ...
      const backupEnergyMetric = alert.metric_values.find(
        (m) => m.metric.sensor_id === 'BKK_BACKUP_ENERGY_CELLULAR'
      );
      const networkStatusMetric = alert.metric_values.find(
        (m) => m.metric.sensor_id === 'BKK_NETWORK_STATUS_PRIMARY'
      );
  ...
  describe('Performance Validation with Bangkok Data Volumes', () => {
    it('should maintain accuracy with realistic Bangkok data volumes', async () => {
      ...
      console.log(
        `Generated ${massiveBangkokDataset.length} sensor readings for Bangkok dataset validation`
      );
      ...
      const massiveBangkokConfig: AlertConfiguration = {
        ...
        description:
          'Validate alert accuracy with realistic Bangkok data volumes',
        ...
        rules: [
          {
            ...
            description:
              'Detect when any building exceeds peak energy thresholds',
            enabled: true,
            priority: 'medium',
            conditions: [
              {
      ...
      const massiveAlerts = await alertEngine.evaluateAlerts(
        [massiveBangkokConfig],
        massiveContext
      );
      const duration = Date.now() - startTime;

      console.log(
        `Processed ${massiveBangkokDataset.length} readings in ${duration}ms`
      );
      console.log(`Generated ${massiveAlerts.length} alerts`);
      console.log(
        `Alert accuracy: ${massiveAlerts.every((alert) => alert.metric_values[0].value > 1000) ? 'PASS' : 'FAIL'}`
      );
